            ...
            {true ?
                ...
                <main className={`bg-bgd flex min-h-screen flex-col pb-4`}>
                    <section className="flex gap-10 justify-center mb-4">
                        <button onClick={() => {/* setField('movie') */ }} className={`flex gap-3 items-center bg-primary text-white px-3 py-2 rounded-b-2xl ${/* field === 'movie' */ true ? 'border-2 border-t-0 border-secondary' : null}`}>
                            Filmes
                            <span className="font-light">( {/* itens?.movies?.length */} )</span>
                        </button>
                        <button onClick={() => {/* setField('tv') */ }} className={`flex gap-3 items-center bg-primary text-white px-3 py-2 rounded-b-2xl ${/* field === 'tv' */ true ? 'border-2 border-t-0 border-secondary' : null}`}>
                            Séries
